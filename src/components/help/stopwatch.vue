    ...
    <div class="auto text-center">
        ...
        <div id="controls">
            <button @click="startStop"
                class="relative rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Start/Stop</button>
            <button @click="reset"
                class="relative rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Reset</button>
        </div>
    </div>
</template>
